...
export default function Login() {
  ...
  return (
    <form>
      <fieldset className="flex flex-col justify-center items-center gap-5 fieldset bg-base-200 border-base-300 rounded-box w-xs border p-4 shadow-2xl">
        <legend className="fieldset-legend text-violet-500">Quicky</legend>
